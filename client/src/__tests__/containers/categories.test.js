...
describe("Categories", () => {
  ...
  it("should edit a category", async () => {
    wrapper.find("input").first().instance().value = "Dairies";

    wrapper.find("CategoryColors").find("button").simulate("click");

    wrapper.find("CategoryColors").find("li").first().simulate("click");
